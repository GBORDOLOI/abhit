                        ...
                        @foreach ($course as $key => $item)
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    <a href="{{route('admin.course.view')}}" data-toggle="tooltip" data-placement="top" title="View Details of Course" class="btn btn-gradient-primary btn-rounded btn-icon anchor_rounded">
