        ...
        <div class="row">
            <div class="col-lg-4">
                <div class="knowledge-forum-right1">
                    ...
                    <div class="knowledge-forum-profile-bottom">
                        ...
                        <div class="knowledge-desc">
                            <h4 class="small-heading-black text-center mt-3 mb0">{{Auth::user()->firstname}} {{Auth::user()->lastname}}</h4>
                            @if(!empty($user_details))
                ...
                <div class="knowledge-forum-right2">
                    <a data-toggle="modal" data-target="#add-question-modal" class="small-heading-grey" >What is your question?</a>
                </div>
            </div>
            <div class="col-lg-8">
                <ul class="nav nav-tabs knowledge-tabs" id="myTab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" data-toggle="tab" href="#question" role="tab" aria-controls="question">Asked By You</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" data-toggle="tab" href="#answer" role="tab" aria-controls="answer">Answered By You</a>
                    </li>
                    {{-- <li class="nav-item">
                    ...
                    <div class="tab-pane active" id="question" role="tabpanel">
                        <div class="knowledge-forum-left-new">
                            <ul class="list-inline answer-list2 ">
                                @foreach($questions_asked_by_user as $question)
                                    @php $enc_id = Crypt::encryptString($question->id)@endphp
                                <li>
                                    <div class="answer-describtion">
                                        <p class="small-text-heading">{{$question->created_at->diffForHumans()}}</p>
                                        ...
                                        <div class="answer-btn-box">
                                            <ul class="list-inline answer-btn-list">
                                                <li><a href="{{route('website.knowledge.details.post',['id' =>  $enc_id])}}">{{$question->total_comments}} Comment</a></li>
                                                <li><a href="javascript:void(0)">{{$question->total_views}} Views</a></li>
                                            </ul>
                                        </div>
                                    </div>
                                </li>
                            ...
                            <ul class="list-inline answer-list2">
                                @if(!$answered_by_user->isEmpty())
                                    @foreach($answered_by_user as $answer)
                                        ...
                                        <li>
                                            <div class="answer-describtion">
                                                <p class="small-text-heading">{{$answer->knowledgeForumPost->created_at->diffForHumans()}}, Asked by: Ramjan Ali Anik, Math Teacher</p>
                                                <h4 class="small-heading-black">{{$answer->knowledgeForumPost->question}}</h4>
                                                <p class="text-justify">{{$answer->knowledgeForumPost->description}}</p>
                                                <a href="#" class="post-link">{{$answer->knowledgeForumPost->links}}</a>
                                                <div class="answer-btn-box">
                                                    <ul class="list-inline answer-btn-list">
                                                        <li><a href="{{route('website.knowledge.details.post',['id' =>  $encrypt_id])}}">{{$answer->knowledgeForumPost->total_comments}} Comment</a></li>
                                                        <li><a href="javascript:void(0)">{{$answer->knowledgeForumPost->total_views}} Views</a></li>
                                                    </ul>
                                                </div>
                                            </div>
                                        </li>
