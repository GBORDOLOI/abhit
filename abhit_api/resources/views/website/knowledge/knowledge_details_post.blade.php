                                    ...
                                    <span class="dropdown" style="float:right;">
                                        ...
                                        <div class="dropdown-menu">
                                            ...
                                            <div class=" dropdown-item social-link-btn">
                                                ...
                                                <a href="#" id="facebookLink" target="_blank"><i class="fa fa-facebook-square" aria-hidden="true" style="color:#1877f2;font-size: 20px;"></i></a>&nbsp;&nbsp;&nbsp;
                                                <a href="#" id="whatsappLink" target="_blank"><i class="fa fa-whatsapp" aria-hidden="true" style="color:#128c7e;font-size: 20px;"></i></a>&nbsp;&nbsp;&nbsp;
                                                <a href="#" id="mailLink" target="_blank"><i class="fa fa-envelope" aria-hidden="true" style="color:#dd4b39;font-size: 20px;"></i></a>&nbsp;&nbsp;&nbsp;
                                                <a href="#" id="redditLink" target="_blank"><i class="fa fa-reddit-square" aria-hidden="true" style="color:#ff4500;font-size: 20px;"></i></a>
